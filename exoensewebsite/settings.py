"""
Django settings for exoensewebsite project.
...
SECRET_KEY = '$yz(azun7l68zqrhs+n$s*9#h@*t9*84)d#d#a8@$nz$_)-)(c'
...
ROOT_URLCONF = 'exoensewebsite.urls'
...
WSGI_APPLICATION = 'exoensewebsite.wsgi.application'
